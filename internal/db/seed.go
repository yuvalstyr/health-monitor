...
func (s *SeedData) createSampleTemplates(ctx context.Context) ([]GaugeTemplate, error) {
	...
	sampleTemplates := []struct {
		...
		},
		{
			...
			description: "Healthy eating tracking",
			target:      10,
			unit:        "servings",
			icon:        "apple",
			frequency:   "bi-weekly",
		...
		{
			name:        "Activity Level",
			description: "Monthly fitness activity",
			target:      100,
			unit:        "points",
			icon:        "activity",
			frequency:   "monthly",
		...
		},
		{
			...
			description: "Monthly personal achievements",
			target:      5,
			unit:        "goals",
			icon:        "trophy",
			frequency:   "monthly",
		...
		{
			name:        "Sleep Quality",
			description: "Quality sleep hours tracking",
			target:      240,
			unit:        "hours",
			icon:        "moon",
			frequency:   "monthly",
